...
$$1 + X + X^2 + X^3 + ...$$ is also not a polynomial (it is a power series in $X$), as polynomials must have finitely many terms.

**Theorem:** Let $R$ be a commutative ring. Then $R[X]$ is a commutative ring
