...
export var twemoji =
  (function () /*! Copyright Twitter Inc. and other contributors. Licensed under MIT */ {
    ...
    var d = {
      ...
      $ = /\uFE0F/g,
      c = /[&<>'"]/g,
      e = /^(?:iframe|noframes|noscript|script|select|style|textarea)$/,
      b = String.fromCharCode
    return d
    function a(d, u) {
      return document.createTextNode(u ? d.replace($, "") : d)
    }
    function _(d) {
    ...
    function t(d, u) {
      if (d === "1fabf") {
        return "".concat(u.base, "noto-goose.png")
      }
    ...
    function n(d, u) {
      for (
        ...
        for (
          b = !1, _ = document.createDocumentFragment(), n = (t = g[m]).nodeValue, i = 0;
          (o = f.exec(n));

        ) {
          if (
            ((s = o.index) !== i && _.appendChild(a(n.slice(i, s), !0)),
              (x = r((p = o[0]))),
              (i = s + p.length),
              (h = u.callback(x, u)),
              x && h)
          ...
          l || _.appendChild(a(p, !1)), (l = null)
        }
        b && (i < n.length && _.appendChild(a(n.slice(i), !0)), t.parentNode.replaceChild(_, t))
      }
      return d
    }
    function o(d, u) {
